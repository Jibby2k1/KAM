...
The quality-scale campaign is queued on HPG from preflight array `38052352` through final report job `38052362`. It contains 60 one-GPU rows, is throttled to exactly four NVIDIA L4s, and registers 45.73 GPU-hours. This is a queued experiment, not a result.
